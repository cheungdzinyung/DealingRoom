        ...
        <div className="edit-item-value-container">
          <div className="edit-item-value-line-container">
            ...
            <div className="line-number-container">
              ...
              <input
                ...
                onChange={this.props.setCurrentPrice}
                className="edit-item-value-line-numbers"
              />
            </div>
          </div>
          <div className="edit-item-value-line-container">
            ...
            <div className="line-number-container">
              ...
              <input
                ...
                onChange={this.props.setMinimunPrice}
                className="edit-item-value-line-numbers"
              />
            </div>
          </div>
          <div className="edit-item-value-line-container">
            ...
            <div className="line-number-container">
              <input
                type="number"
                defaultValue={this.props.itemStock.toString()}
                onChange={this.props.setStock}
                className="edit-item-value-line-numbers"
              />
            </div>
          </div>
