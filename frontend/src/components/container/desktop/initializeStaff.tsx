...
class PureInitialize extends React.Component<IInitializeProps, {}> {
    ...
    public componentDidUpdate() {
        ...
        if (this.props.menuReady && this.props.userProfileReady && this.props.allOrdersReady) {
...
const mapStateToProps = (state: IRootState) => {
    return {
        ...
        menuReady: state.staff.staffInit.menuReady,
        userProfileReady: state.staff.staffInit.userProfileReady,
        userProfile: state.staff.staffInit.userProfile,
        allOrders: state.staff.staffInit.allOrders,
        allOrdersReady: state.staff.staffInit.allOrdersReady,
